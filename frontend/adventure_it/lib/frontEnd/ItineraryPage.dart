                                ...
                                PopupMenuButton(
                                    ...
                                    onSelected: (value) {
                                      if (value == 1) {
                                        ...
                                        dateController.text =
                                            entryModel.entries!.elementAt(
                                                index).timestamp.substring(
                                                0, 10);
                                        date = DateTime(int.parse(
                                            entryModel.entries!.elementAt(
                                                index).timestamp.substring(
                                                0, 4)),
                                            int.parse(
                          ...
                          child: InkWell(
                              onTap:(){
                                ...
                                showDialog(
                                    ...
                                    builder: (BuildContext context) {
                                      return AlertBox(
                                          currentItinerary!, provider, entryModel.popular.elementAt(entryModel!.popular!.elementAt(index)));
                                    });
                              },
                              hoverColor: Theme
                                  .of(context)
