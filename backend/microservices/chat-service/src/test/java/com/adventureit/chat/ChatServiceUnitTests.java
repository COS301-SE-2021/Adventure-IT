...
class ChatServiceUnitTests{
    ...
    @Test
    @Description("Testing to make sure that the CreateTimelineRequest returns the correct parameters that were passed in")
     void sendDirectMessageRequestTest(){
        //Given
        UUID mockChatID = UUID.randomUUID();
    ...
    @Test
    @Description("Testing to make sure that the CreateTimelineRequest returns the correct parameters that were passed in")
     void sendGroupMessageRequestTest(){
    ...
    @Test
    @Description("Testing to make sure that the CreateTimelineRequest returns the correct parameters that were passed in")
     void sendDirectMessageFailTest() throws Exception {
        //Given
    ...
    @Test
    @Description("Testing to make sure that the CreateTimelineRequest returns the correct parameters that were passed in")
     void sendGroupMessageTestFail() throws Exception {
        //Given
    ...
    @Test
    @Description("Testing to make sure that the CreateTimelineRequest returns the correct parameters that were passed in")
     void getGroupChatByAdventureIDTest() throws Exception {
    ...
    @Test
    @Description("Testing to make sure that the CreateTimelineRequest returns the correct parameters that were passed in")
     void getGroupChatByAdventureIDTestFail() throws Exception {
        //Given
    ...
    @Test
    @Description("Testing to make sure that the CreateTimelineRequest returns the correct parameters that were passed in")
     void getGroupChatTest() throws Exception {
        UUID mockGroupChatID = UUID.randomUUID();
        UUID mockAdventureId = UUID.randomUUID();
        List<UUID> participants = new ArrayList<>();
        participants.add(UUID.randomUUID());
    ...
    @Test
    @Description("Testing to make sure that the CreateTimelineRequest returns the correct parameters that were passed in")
    void getGroupChatTestFail() throws Exception {
        //Given
