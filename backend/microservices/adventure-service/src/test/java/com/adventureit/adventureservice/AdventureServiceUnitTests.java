...
public class AdventureServiceUnitTests {
    ...
    Adventure mockAdventure1 = new Adventure("Mock Adventure 1","Mock Description 1", UUID.randomUUID(), validUserID1, LocalDate.of(2021, 7, 5),LocalDate.of(2021, 7, 9));
    Adventure mockAdventure2 = new Adventure("Mock Adventure 2","Mock Description 2", UUID.randomUUID(), validUserID1, LocalDate.of(2021, 1, 3),LocalDate.of(2022, 1, 2));
    Adventure mockAdventure3 = new Adventure("Mock Adventure 3", "Mock Description 3",UUID.randomUUID(), validUserID1, LocalDate.of(2022, 1, 4),LocalDate.of(2022, 1, 22));
