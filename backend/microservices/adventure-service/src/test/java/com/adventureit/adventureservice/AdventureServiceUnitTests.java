...
public class AdventureServiceUnitTests {
    ...
    Adventure mockAdventure1 = new Adventure("Mock Adventure 1","Mock Description 1", UUID.randomUUID(), validUserID1, LocalDate.of(2021, 1, 1),LocalDate.of(2021, 1, 2));
    Adventure mockAdventure2 = new Adventure("Mock Adventure 2","Mock Description 1", UUID.randomUUID(), validUserID1, LocalDate.of(2021, 1, 1),LocalDate.of(2021, 2, 1));
    Adventure mockAdventure3 = new Adventure("Mock Adventure 3","Mock Description 1", UUID.randomUUID(), validUserID1, LocalDate.of(2021, 1, 1),LocalDate.of(2021, 1, 22));
