...
public class BudgetServiceUnitTests {
        ...
        Budget mockBudget1 = new Budget(validBudgetID1,"Mock Budget 1",UUID.randomUUID(),UUID.randomUUID(),trans,1000000);
        Budget mockBudget2 = new Budget(validBudgetID2,"Mock Budget 2",UUID.randomUUID(),UUID.randomUUID(),trans2,10000000);

        @Test
        /* Ensuring a user can create a budget */
        public void createBudgetValid_ReturnTrue() throws Exception {
                CreateBudgetResponse createBudgetResponse = sut.createBudget(UUID.randomUUID(),"Mock Name",UUID.randomUUID(),UUID.randomUUID(),5000);
        ...
        public void createBudgetExistingID_ThrowException() throws Exception {
                ...
                Assertions.assertThrows(Exception.class, ()->{
                    sut.createBudget(validBudgetID1,"Mock Name",UUID.randomUUID(),UUID.randomUUID(),10000);
                });
        }
        ...
        public void createBudgetNullField_ThrowException() throws Exception {
                Assertions.assertThrows(Exception.class, ()->{
                    sut.createBudget(null,"Mock Name",UUID.randomUUID(),UUID.randomUUID(),15000);
                });
        }
