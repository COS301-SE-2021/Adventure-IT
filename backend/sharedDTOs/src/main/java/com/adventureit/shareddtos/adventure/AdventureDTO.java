package com.adventureit.shareddtos.adventure;
...
public class AdventureDTO{
     ...
     */
    public AdventureDTO(String name, String description, UUID adventureId, UUID ownerId, LocalDate sd, LocalDate ed, UUID location){
        this.name=name;
